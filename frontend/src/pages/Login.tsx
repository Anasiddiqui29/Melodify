...
export default function Login() {
  ...
  return (
    <div
      className="min-h-[calc(100vh-80px)] relative overflow-hidden flex items-center justify-center px-4 py-16 bg-[#0B0B0F]"
    ...
    >
      ...
      <style>{`
        ...
        .vinyl-mark { animation: spin-slow 14s linear infinite; }
        @media (prefers-reduced-motion: reduce) {
          .vinyl-mark { animation: none; }
        }
      `}</style>

      {/* Ambient groove pattern, top-right corner */}
      <svg
        className="pointer-events-none absolute -top-24 -right-24 w-[420px] h-[420px] opacity-[0.07]"
        viewBox="0 0 420 420"
        fill="none"
      >
        {[190, 150, 110, 70, 30].map((r) => (
          <circle key={r} cx="210" cy="210" r={r} stroke="#C9A962" strokeWidth="1" />
        ))}
      </svg>

      {/* Vignette */}
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_20%,rgba(201,169,98,0.06),transparent_60%)]" />
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="text-center mb-9">
          <div className="inline-flex items-center justify-center mb-6">
            <svg
              className="vinyl-mark w-14 h-14"
              viewBox="0 0 56 56"
              fill="none"
            >
              <circle cx="28" cy="28" r="27" fill="#0B0B0F" stroke="#C9A962" strokeWidth="1" />
              <circle cx="28" cy="28" r="22" stroke="#C9A962" strokeOpacity="0.25" strokeWidth="0.75" />
              <circle cx="28" cy="28" r="17" stroke="#C9A962" strokeOpacity="0.35" strokeWidth="0.75" />
              <circle cx="28" cy="28" r="12" stroke="#C9A962" strokeOpacity="0.45" strokeWidth="0.75" />
          ...
          <p className="text-[#A39D91] text-[15px]">
            Sign in to pick up where the last track left off.
          </p>
        </div>
          ...
          <form onSubmit={submit} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="text-[13px] font-medium text-[#D8D3C8]">
                  Password
                </label>
                ...
                >
                  {showPassword ? (
                    <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.6} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l18 18" />
                    </svg>
                  ) : (
                    <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-2 pt-1">
              <input
                type="checkbox"
                className="w-4 h-4 rounded border-[#3A362E] bg-[#0B0B0F] accent-[#C9A962]"
              />
